...
/**
 * A simple program to test the buildTreeFromString method.
 *
...
class BuildTreeFromStringTest {
	...
	void testBuild2Operands() {
		...
		TreeNode<String> test = ExpressionBuilder.buildTreeFromString("3 -3 -");
	...
	void testBuild3Operands() {
		...
		TreeNode<String> truth = build(tree);
		TreeNode<String> test = ExpressionBuilder.buildTreeFromString("3 -3 - 2 +");
		assertEquals(truth, test);
	}
	...
	void testBuild4Operands() {
		...
		TreeNode<String> truth = build(tree);
		TreeNode<String> test = ExpressionBuilder.buildTreeFromString("3 -3 - 2 / 9 +");
		assertEquals(truth, test);
	}
	...
	void testBuild5Operands() {
		...
		TreeNode<String> truth = build(tree);
		TreeNode<String> test = ExpressionBuilder.buildTreeFromString("3 -3 7 + - 2 / 9 +");
		assertEquals(truth, test);
	}
