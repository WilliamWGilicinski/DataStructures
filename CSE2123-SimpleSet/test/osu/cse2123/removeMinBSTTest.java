...
class removeMinBSTTest {
	...
	@Test
	void testRemoveMinRootNodeTrue() {
		String trueInput = "(banana()())";
		TreeNode<String> truth = null;
		StringBuilder tree = new StringBuilder(trueInput);
		TreeNode<String> test = build(tree);
		test = BinarySearchTreeMethods.removeMin(test);
		assertEquals(truth, test);
	}
	
	
	@Test
	void testRemoveMinRootOnlyRight() {
		String trueInput = "(carrot(carbon()())(dill()()))";
		StringBuilder trueResult = new StringBuilder(trueInput);
		TreeNode<String> truth = build(trueResult);
		String testInput = "(banana()(carrot(carbon()())(dill()())))";
		StringBuilder tree = new StringBuilder(testInput);
		TreeNode<String> test = build(tree);
		test = BinarySearchTreeMethods.removeMin(test);
		assertEquals(truth, test);
	}
	...
	@Test
	void testRemoveMinOneLevel() {
		String trueInput = "(banana()(carrot(carbon()())(dill()())))";
		StringBuilder trueResult = new StringBuilder(trueInput);
		TreeNode<String> truth = build(trueResult);
		String testInput = "(banana(apple()())(carrot(carbon()())(dill()())))";
		StringBuilder tree = new StringBuilder(testInput);
		TreeNode<String> test = build(tree);
		test = BinarySearchTreeMethods.removeMin(test);
		assertEquals(truth, test);
	...
	@Test
	void testRemoveMinTwoLevels() {
		String trueInput = "(banana(apple()(aqueduct()()))(carrot(carbon()())(dill()())))";
		StringBuilder trueResult = new StringBuilder(trueInput);
		TreeNode<String> truth = build(trueResult);
		String testInput = "(banana(apple(aardvark()())(aqueduct()()))(carrot(carbon()())(dill()())))";
		StringBuilder tree = new StringBuilder(testInput);
		TreeNode<String> test = build(tree);
		test = BinarySearchTreeMethods.removeMin(test);
		assertEquals(truth, test);
	...
	void testFindMinTwoLevelsRight() {
		String trueInput = "(banana(aqueduct()())(carrot(carbon()())(dill()())))";
		StringBuilder trueResult = new StringBuilder(trueInput);
		TreeNode<String> truth = build(trueResult);
		String testInput = "(banana(apple()(aqueduct()()))(carrot(carbon()())(dill()())))";
		StringBuilder tree = new StringBuilder(testInput);
		TreeNode<String> test = build(tree);
		test = BinarySearchTreeMethods.removeMin(test);
		assertEquals(truth, test);
